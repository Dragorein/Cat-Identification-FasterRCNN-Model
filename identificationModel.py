...
def identify():
    ...
    # with open("models/model_vgg_config.pickle", 'rb') as f_in:
    #     C = pickle.load(f_in)
    # with open("models/model_vgg_config.pickle", 'rb') as f_in:
    C = pickle.load(open("models/model_vgg_config.pickle", 'rb'))

    # turn off any data augmentation at test time
    C.use_horizontal_flips = False
    C.use_vertical_flips = False
    C.rot_90 = False
    C.weight_path = "models/model_frcnn_vgg_weight.hdf5"
    ...
    print('Loading weights from {}'.format(C.weight_path))
    model_rpn.load_weights(C.weight_path, by_name=True)
    model_classifier.load_weights(C.weight_path, by_name=True)
...
def main():
    ...
    print("result Image Path : ", resultImagePath)
